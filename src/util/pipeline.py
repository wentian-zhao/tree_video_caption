...
class SupervisedPipeline(BasePipeline):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--max-epoch', type=int, help='maximum epochs to run (start from 1)', required=True)
        parser.add_argument('--save-every-epoch', default=1, type=int, help='if 1, save after every epoch')
    ...
    def train(self):
        ...
        assert self.args.max_epoch is not None
